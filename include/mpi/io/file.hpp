...
public:
  ...
  template <typename type> [[nodiscard]]                     
  status                               write_all             (const type& data)
  {
    using adapter = container_adapter<type>;
  ...
  template <typename type>                                   
  void                                 write_all_begin       (const type& data)
  {
    using adapter = container_adapter<type>;
  ...
  template <typename type, typename = std::enable_if_t<!std::is_same_v<type, const void*>>> [[nodiscard]]
  status                               write_all_end         (const type& data)
  {
    using adapter = container_adapter<type>;
  ...
  template <typename type, typename = std::enable_if_t<!std::is_same_v<type, const void*>>> [[nodiscard]]
  status                               write_at_all_end      (const type& data)
  {
    using adapter = container_adapter<type>;
  ...
  template <typename type> [[nodiscard]]                     
  status                               write_ordered         (const type& data)
  {
    using adapter = container_adapter<type>;
  ...
  template <typename type>                                   
  void                                 write_ordered_begin   (const type& data)
  {
    using adapter = container_adapter<type>;
  ...
  template <typename type, typename = std::enable_if_t<!std::is_same_v<type, const void*>>> [[nodiscard]]
  status                               write_ordered_end     (const type& data)
  {
    using adapter = container_adapter<type>;
  ...
  template <typename type> [[nodiscard]]                     
  status                               write_shared          (const type& data)
  {
    using adapter = container_adapter<type>;
  ...
  template <typename type> [[nodiscard]]                     
  request                              immediate_write       (const type& data)
  {
    using adapter = container_adapter<type>;
  ...
  template <typename type> [[nodiscard]]                     
  request                              immediate_write_all   (const type& data)
  {
    using adapter = container_adapter<type>;
  ...
  template <typename type> [[nodiscard]]
  request                              immediate_write_shared(const type& data)
  {
    using adapter = container_adapter<type>;
